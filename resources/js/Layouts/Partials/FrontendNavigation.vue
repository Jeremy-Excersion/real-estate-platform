      ...
      <div class="flex h-16 justify-between">
        <div class="flex">
          ...
          <div class="flex flex-shrink-0 items-center">
            <a href="/">
              <img class="block h-8 w-auto" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=500" alt="Real Estate Platform" />
            </a>
          </div>
        ...
        <div class="flex items-center">
          ...
          <div v-if="$page.props.loggedIn" class="hidden md:ml-4 md:flex md:flex-shrink-0 md:items-center">
          ...
          <div v-else class="ml-3 flex-shrink-0">
            <NavLink :href="route('login')" class="">
